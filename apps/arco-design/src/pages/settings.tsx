...
import { Avatar, Button, Card, Descriptions, Form, Input, List, Message, Modal, Select, Switch, Table, Tabs, Tag, Typography, Upload } from "@arco-design/web-react"
...
export function SettingsPage() {
  ...
  return (
    <>
      ...
      <Tabs defaultActiveTab="profile" tabPosition="left" className="settings-tabs">
      ...
      <Modal title="删除账户" visible={dangerOpen} onCancel={() => setDangerOpen(false)} onOk={() => { setDangerOpen(false); Message.success("已提交删除请求") }}><Typography.Paragraph>请输入 DELETE 确认操作。</Typography.Paragraph><Input placeholder="DELETE" /></Modal>
    </>
  )
}
