    ...
    <Box>
      ...
      <Tabs.Root defaultValue="profile">
          ...
          <Card mt="4">
            ...
            <Flex direction="column" gap="3">
              {sessions.map((session) => (
                <Flex key={session.device} align="center" justify="between">
                  <Box>
        ...
        <Tabs.Content value="notifications">
          <Card mt="4">
            <Flex direction="column" gap="4">
              <Heading size="4">通知偏好</Heading>
              {["订单更新", "团队动态", "产品新闻"].map((label) => (
              ...
              <SegmentedControl.Root defaultValue="email">
                ...
                <SegmentedControl.Item value="push">推送</SegmentedControl.Item>
                <SegmentedControl.Item value="inapp">
                  站内
                </SegmentedControl.Item>
          ...
          <Card mt="4">
            <Box style={{ overflowX: "auto" }}>
              <Table.Root variant="surface">
                <Table.Header>
                  <Table.Row>
                    <Table.ColumnHeaderCell>成员</Table.ColumnHeaderCell>
                    <Table.ColumnHeaderCell>角色</Table.ColumnHeaderCell>
                    <Table.ColumnHeaderCell>最近活跃</Table.ColumnHeaderCell>
                    ...
                    <Table.Row key={member.email}>
                      <Table.Cell>
                        <Flex align="center" gap="2">
                          <Avatar size="2" fallback={member.name.slice(0, 1)} />
                          <Box>
            ...
            {plans.map((plan) => (
              <Card key={plan.name}>
                <Flex justify="between">
                  ...
                  {plan.recommended ? <Badge color="green">推荐</Badge> : null}
                </Flex>
                <Heading size="6" mt="3">
                  {plan.price === null ? "联系销售" : `¥${plan.price}`}
                </Heading>
      ...
      <Card mt="5" style={{ border: "1px solid var(--red-7)" }}>
        <Flex direction="column" gap="3">
