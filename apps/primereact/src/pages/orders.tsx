...
export function OrdersPage() {
  const [selected, setSelected] = useState<Order | null>(null), [checked, setChecked] = useState<Order[]>([]), [state, setState] = useState("normal"), toast = useRef<Toast>(null)
