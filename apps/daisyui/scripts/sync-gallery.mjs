...
const source = readFileSync(`${root}apps/daisyui/src/coverage.ts`, "utf8")
const galleryPath = `${root}apps/daisyui/gallery.json`
...
if (missing.length) throw new Error(`coverage.ts 缺少: ${missing.join(", ")}`)
