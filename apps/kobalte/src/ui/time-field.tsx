...
export function TimeField(props: { label?: string; defaultValue?: { hour?: number; minute?: number }; disabled?: boolean; onChange?: (value: { hour?: number; minute?: number }) => void }) {
  return (
    <KobalteTimeField defaultValue={props.defaultValue ?? { hour: 9, minute: 30 }} onChange={props.onChange} hourCycle={24} granularity="minute" forceLeadingZeros disabled={props.disabled} class="grid gap-1.5">
