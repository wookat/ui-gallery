...
import { SHARED_IMPORTS, moveItemInArray, statusTone } from '../shared/material';
...
export class ComponentsPage implements AfterViewInit {
  ...
  readonly emailInput = new FormControl('not-an-email', [Validators.required, Validators.email]);
