        ...
        <section class="component-section" [id]="'comp-' + name">
          ...
          <nz-card nzSize="small">
            @switch (name) {
              ...
              @case ('Card') { <div class="demo-row"><nz-card nzSize="small" nzTitle="小卡片">卡片内容</nz-card><nz-card nzTitle="卡片标题" nzHoverable>卡片内容</nz-card><nz-card nzTitle="加载中" [nzLoading]="true" class="loading-card">卡片内容</nz-card></div> }
              ...
              @case ('Progress') { <div class="demo-row"><nz-progress nzSize="small" [nzPercent]="68" /><nz-progress [nzPercent]="82" nzStatus="success" /><nz-progress [nzPercent]="42" nzStatus="exception" /><nz-progress [nzPercent]="60" [nzSteps]="5" /><nz-progress nzType="circle" [nzPercent]="42" /></div> }
