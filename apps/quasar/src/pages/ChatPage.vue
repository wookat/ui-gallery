...
<template>
  <div class="chat-page">
    ...
    <q-card v-else bordered class="chat-card">
      <q-dialog v-model="drawer" position="left" class="lt-md">
        <q-card style="width: 280px; max-width: 80vw" class="fit">
