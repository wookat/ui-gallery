...
@Component({
  ...
  imports: [
    ...
    NzFloatButtonModule, NzFlexModule, NzFormModule, NzGridModule, NzImageModule, NzInputModule, NzInputNumberModule, NzLayoutModule, NzListModule, NzMenuModule,
        ...
        <section class="component-section" [id]="'comp-' + name">
          ...
          <nz-card nzSize="small">
            @switch (name) {
              ...
              @case ('Input') { <div class="demo-row"><input nz-input nzSize="small" placeholder="小尺寸" /><input nz-input placeholder="输入内容" /><input nz-input nzSize="large" nzStatus="error" value="校验失败" /><input nz-input nzDisabled value="禁用" /></div> }
              ...
              @case ('AvatarGroup') { <nz-avatar-group><nz-avatar>林</nz-avatar><nz-avatar>周</nz-avatar><nz-avatar>陈</nz-avatar><nz-avatar nzText="+3" /></nz-avatar-group><nz-avatar-group nzSize="small"><nz-avatar>小</nz-avatar><nz-avatar>组</nz-avatar></nz-avatar-group> }
              ...
              @case ('Navbar') { <nz-layout class="mini-layout"><nz-header><ul nz-menu nzMode="horizontal"><li nz-menu-item nzSelected>工作台</li><li nz-menu-item>订单</li></ul><div class="layout-actions"><button nz-button nzType="text"><ui-icon name="bell" /></button><button nz-button nzType="text">账户</button></div></nz-header></nz-layout> }
              @case ('Sidebar') { <nz-layout class="sidebar-demo"><nz-sider nzCollapsible><ul nz-menu nzMode="inline"><li nz-menu-item nzSelected>概览</li><li nz-submenu nzTitle="管理"><ul><li nz-menu-item>订单</li><li nz-menu-item>客户</li></ul></li></ul></nz-sider><nz-content>内容区域</nz-content></nz-layout> }
              ...
              @case ('Layout') { <nz-layout class="layout-demo"><nz-sider>侧栏</nz-sider><nz-layout><nz-header>页头</nz-header><nz-content>内容</nz-content><nz-footer>页脚</nz-footer></nz-layout></nz-layout> }
...
export class ComponentsPage {
  ...
  rangeValue = [20, 70]; ratingValue = 4; colorValue = '#1890ff'; drawerOpen = false; darkTheme = false;
