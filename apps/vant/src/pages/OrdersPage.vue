...
<template>
  <div class="page">
    ...
    <div v-else class="card order-card">
      ...
      <van-pagination v-model="page" :page-count="3" mode="simple" />
    </div>
    <van-popup v-model:show="calendar" position="bottom"><van-calendar type="range" @confirm="calendar = false" /></van-popup>
