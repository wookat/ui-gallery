...
/** 提示：hifi [data-tip]::after —— 反色底、caption、radius.sm、无箭头 */
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 w-fit max-w-popover rounded-sm bg-bg-inverse px-2 py-1 text-role-caption text-fg-inverse shadow-md",
          className,
        )}
        {...props}
      />
