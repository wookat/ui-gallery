          ...
          <Stack gap="5">
            ...
            <form onSubmit={submit}>
              <Stack gap="4">
                ...
                <Field.Root invalid={submitted}><Field.Label>密码</Field.Label><InputGroup endElement={<IconButton aria-label="切换密码可见性" size="sm" variant="ghost" onClick={() => setVisible((value) => !value)}><Icon name={visible ? "eye-off" : "eye"} width="16" height="16" /></IconButton>}><Input type={visible ? "text" : "password"} placeholder="••••••••" /></InputGroup>{submitted ? <Field.ErrorText>请输入密码</Field.ErrorText> : null}</Field.Root>
            ...
            <Flex gap="2" direction={{ base: "column", sm: "row" }}><Button variant="outline" flex="1"><Icon name="globe" width="16" height="16" />Google</Button><Button variant="outline" flex="1"><Icon name="github" width="16" height="16" />GitHub</Button><Button variant="outline" flex="1"><Icon name="message-circle" width="16" height="16" />微信</Button></Flex>
            <Separator />
