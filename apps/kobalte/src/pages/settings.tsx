  ...
  return <div class="space-y-6">
    ...
    <Tabs.Root value={tab()} onChange={setTab} orientation="vertical" class="grid gap-6 md:grid-cols-[180px_minmax(0,1fr)]">
      ...
      <div class="min-w-0">
        ...
        <Card class="mt-6 border-red-200 dark:border-red-900"><CardHeader><CardTitle class="text-red-600 dark:text-red-400">危险区</CardTitle><CardDescription>删除账号后，所有项目和数据将无法恢复。</CardDescription></CardHeader><CardContent><Button variant="destructive" onClick={() => setDeleteOpen(true)}>删除账号</Button></CardContent></Card>
      </div>
    </Tabs.Root>
