...
const submit = () => { formRef.value?.validate((ok) => { if (!ok) return; failed.value = true; loading.value = true; window.setTimeout(() => { loading.value = false; ElMessage.success("演示登录已提交") }, 1200) }) }
</script>
