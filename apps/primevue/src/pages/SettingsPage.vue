...
@media (max-width: 767px) { .settings-tabs { display: block; } .settings-tabs :deep(.p-tablist) { width: 100%; overflow-x: auto; } .settings-tabs :deep(.p-tablist-tab-list) { flex-direction: row; width: 100%; border-bottom: 1px solid var(--p-tabs-tablist-border-color); } .settings-tabs :deep(.p-tab) { flex: 1 1 0; width: auto; min-width: 0; justify-content: center; padding: 10px 6px; font-size: 14px; white-space: nowrap; } .settings-tabs :deep(.p-tablist-active-bar) { display: block; } .settings-tabs :deep(.p-tabpanels) { padding-top: 16px; } .profile-layout { grid-template-columns: 1fr; } .invite-group { flex-wrap: wrap; } }
</style>
