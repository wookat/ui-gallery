...
function demo(name: string): string {
  ...
  switch (name) {
    ...
    case "Table": return `<figure class="overflow-auto"><table class="striped demo-table"><thead><tr><th><label class="check-cell"><input type="checkbox" aria-label="全选"></label></th><th>名称 ↕</th><th>状态</th><th>金额</th></tr></thead><tbody><tr><td><label class="check-cell"><input type="checkbox" aria-label="选择 ORD-2401"></label></td><td>ORD-2401</td><td><mark>已支付</mark></td><td>¥1,280.00</td></tr><tr><td><label class="check-cell"><input type="checkbox" aria-label="选择 ORD-2402"></label></td><td>ORD-2402</td><td><mark>处理中</mark></td><td>¥420.00</td></tr><tr><td colspan="4">暂无更多数据</td></tr></tbody></table></figure><footer role="group">${button("上一页", "outline", "disabled")}${button("1")}${button("下一页", "outline")}</footer>`
    ...
    case "Card": return `<div class="card-demo"><article><header><h3>基础卡片</h3></header><p>卡片正文内容。</p><footer>${button("操作", "outline")}</footer></article><article><div class="card-image-placeholder" role="img" aria-label="卡片媒体区域">${icon("image", 28)}</div><h3>图片卡片</h3><p>带媒体区域的卡片。</p><footer>${button("编辑", "outline")}${button("删除", "outline contrast")}</footer></article></div>`
    ...
    case "Progress": return `<progress value="65" max="100"></progress><progress></progress><div class="progress-row"><div class="circular-progress" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="--value: 65"><span>65%</span></div><div class="steps-progress" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="3" aria-label="分步进度 2 / 3"><span class="done"></span><span class="done"></span><span></span></div></div>`
