...
const navigate = (path: string) => { router.push(path); drawer.value = false }
const toggleTheme = () => {
...
<template>
  <el-container class="shell">
    <el-aside v-if="!mobile" :width="collapsed ? '64px' : '240px'" class="sidebar">
      ...
      <div class="sidebar-user" @click="navigate('/settings')"><el-avatar size="small">林</el-avatar><span v-if="!collapsed">林晓</span></div>
