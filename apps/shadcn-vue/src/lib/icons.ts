...
export const lucide: Record<string, IconComponent> = {
  ...
  'chevron-left': ChevronLeft, 'chevron-right': ChevronRight, 'chevron-up': ChevronUp, 'chevrons-up-down': ChevronDown,
...
export const tabler: Record<string, IconComponent> = {
  ...
  'chevron-up': IconChevronUp, 'chevrons-up-down': IconChevronDown, 'circle-help': IconInfoCircle, clipboard: IconClipboard, clock: IconClock,
...
export const phosphor: Record<string, IconComponent> = {
  ...
  'chevron-down': PhCaretDown, 'chevron-left': PhCaretLeft, 'chevron-right': PhCaretRight, 'chevron-up': PhCaretUp, 'chevrons-up-down': PhCaretDown,
...
export const heroicons: Record<string, IconComponent> = {
  ...
  'chevron-up': HeroChevronUp, 'chevrons-up-down': HeroChevronDown, 'circle-help': HeroInfo, clipboard: HeroClipboard, clock: HeroClock,
