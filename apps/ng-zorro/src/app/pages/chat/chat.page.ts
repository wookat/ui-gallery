...
@Component({
  ...
  `,
  styles: `.chat-page{display:flex;flex-direction:column;height:calc(100vh - 48px);min-height:620px}.chat-header{display:flex;align-items:center;gap:16px;margin-bottom:16px}.chat-header h1{margin:0;flex:1}.chat-layout{display:flex;flex:1;min-height:0;border:1px solid #f0f0f0;border-radius:8px;overflow:hidden}.conversation-panel{width:280px;flex:0 0 280px;border-right:1px solid #f0f0f0;padding:16px}.conversation{display:grid;gap:12px}.conversation h4{margin:8px 0 0;color:rgba(0,0,0,.45)}.conversation-item{display:flex;justify-content:space-between;gap:8px;padding:10px;border-radius:6px;cursor:pointer}.conversation-item:hover{background:rgba(0,0,0,.02)}.conversation-item small{display:block;color:rgba(0,0,0,.45);margin-top:4px}.message-panel{display:flex;flex-direction:column;min-width:0;flex:1}.messages{overflow:auto;flex:1;padding:24px}.message{display:flex;gap:12px;max-width:820px;margin-bottom:24px}.message.user-message{margin-left:auto;flex-direction:row-reverse}.bubble{min-width:0;max-width:calc(100% - 48px);padding:12px 16px;border-radius:10px;background:rgba(0,0,0,.02)}.user-message .bubble{background:#1890ff;color:#fff}.message-meta{font-size:12px;color:rgba(0,0,0,.45);margin-bottom:8px}.user-message .message-meta{color:rgba(255,255,255,.72)}.markdown{overflow-x:auto}.markdown :last-child{margin-bottom:0}.markdown table{width:100%;border-collapse:collapse}.markdown th,.markdown td{border:1px solid #f0f0f0;padding:8px 12px;text-align:left}.code-block{position:relative;border:1px solid #f0f0f0;border-radius:6px;background:#fff;margin:12px 0;overflow:auto}.code-header{display:flex;align-items:center;justify-content:space-between;padding:8px 12px;border-bottom:1px solid #f0f0f0;font-size:12px;color:rgba(0,0,0,.45)}.code-block pre{margin:0;padding:16px;overflow:auto}.sources{display:flex;flex-wrap:wrap;gap:6px;margin-top:12px}.streaming{display:flex;align-items:center;gap:6px;color:rgba(0,0,0,.45);margin-top:10px}.cursor{display:inline-block;width:7px;height:16px;background:currentColor;animation:blink 1s steps(2,start) infinite}@keyframes blink{50%{opacity:0}}.composer{padding:16px;border-top:1px solid #f0f0f0}.composer-row{display:flex;align-items:flex-end;gap:8px}.composer-row textarea{flex:1;resize:none}.model{width:130px}.hint{font-size:12px;color:rgba(0,0,0,.45);text-align:right;margin-top:6px}.suggestions{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px}.empty-chat,.loading{display:grid;place-items:center;align-content:center;gap:12px;flex:1;text-align:center}.suggestion-cards{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;max-width:600px}.suggestion-cards nz-card{cursor:pointer}.mobile-only{display:none}:host-context(.dark) .chat-layout{border-color:#303030}:host-context(.dark) .conversation-panel{border-color:#303030}:host-context(.dark) .conversation-item:hover,.dark .bubble{background:rgba(255,255,255,.04)}:host-context(.dark) .conversation h4,:host-context(.dark) .conversation-item small,:host-context(.dark) .message-meta,:host-context(.dark) .streaming,:host-context(.dark) .hint{color:rgba(255,255,255,.45)}:host-context(.dark) .code-block{border-color:#303030;background:#141414}:host-context(.dark) .code-header{border-color:#303030;color:rgba(255,255,255,.45)}:host-context(.dark) .markdown th,:host-context(.dark) .markdown td{border-color:#303030}:host-context(.dark) .composer{border-color:#303030}@media(max-width:767px){.chat-page{height:calc(100vh - 32px);min-height:580px}.conversation-panel{display:none}.mobile-only{display:inline-flex}.chat-header{flex-wrap:wrap}.chat-header nz-radio-group{order:3;width:100%;overflow:auto}.messages{padding:16px}.model{display:none}.composer-row button:last-child{white-space:nowrap}.suggestion-cards{grid-template-columns:1fr}.bubble{max-width:calc(100% - 42px)}}`,
})
