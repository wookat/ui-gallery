...
function FormLayoutDemo() {
  return <Row className="g-4"><Col lg={4}><h3 className="h6 text-secondary">垂直</h3><Form><Form.Group className="mb-2" controlId="fl-v-name"><Form.Label>姓名</Form.Label><Form.Control placeholder="姓名" /></Form.Group><Form.Group className="mb-2" controlId="fl-v-email"><Form.Label>邮箱</Form.Label><Form.Control type="email" placeholder="name@example.com" /><Form.Text>用于接收通知。</Form.Text></Form.Group><Form.Check type="switch" id="fl-v-switch" label="记住我" className="mb-2" /><Button type="button">提交</Button></Form></Col><Col lg={4}><h3 className="h6 text-secondary">水平</h3><Form><Form.Group as={Row} className="mb-2" controlId="fl-h-name"><Form.Label column sm={3}>姓名</Form.Label><Col sm={9}><Form.Control placeholder="姓名" /></Col></Form.Group><Form.Group as={Row} className="mb-2" controlId="fl-h-email"><Form.Label column sm={3}>邮箱</Form.Label><Col sm={9}><Form.Control type="email" placeholder="name@example.com" /></Col></Form.Group><Row><Col sm={{ span: 9, offset: 3 }}><Button type="button">提交</Button></Col></Row></Form></Col><Col lg={4}><h3 className="h6 text-secondary">内联</h3><Form><Row className="g-2 align-items-center"><Col xs="auto"><Form.Label htmlFor="fl-i-name" visuallyHidden>姓名</Form.Label><Form.Control id="fl-i-name" placeholder="姓名" /></Col><Col xs="auto"><Form.Check type="checkbox" id="fl-i-check" label="记住我" /></Col><Col xs="auto"><Button type="button">提交</Button></Col></Row></Form></Col></Row>
}
