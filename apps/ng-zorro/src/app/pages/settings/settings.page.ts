...
@Component({
  ...
  `,
  styles: `.settings-page{display:grid;grid-template-columns:minmax(0,1fr);gap:16px}.settings-page>*{min-width:0}.settings-tabs{min-height:560px}.security-row{display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #f0f0f0;padding:12px 0}.session,.member{display:flex;align-items:center;justify-content:space-between;gap:12px}.member{justify-content:flex-start}.member small{display:block;color:rgba(0,0,0,.45)}.plans{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;margin:16px 0}.price{font-size:20px;font-weight:600;margin:12px 0}.notify-segment{margin-top:16px}.danger-zone{border:1px solid #ff4d4f}:host-context(.dark) .security-row{border-color:#303030}:host-context(.dark) .member small{color:rgba(255,255,255,.45)}@media(max-width:767px){.plans{grid-template-columns:1fr}.settings-tabs{min-height:0}}`,
})
