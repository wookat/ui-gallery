...
export const descriptions: Record<string, string> = {
  ...
  Tree: "Kobalte Accordion · nested nodes",
  ...
  Navbar: "Navbar composition · light and dark bars",
