...
@Component({
  ...
  template: `
    <main class="page form-page">
      ...
      <mat-card class="form-stepper-card"><mat-card-content><mat-stepper [orientation]="verticalStepper() ? 'vertical' : 'horizontal'" linear #stepper (selectionChange)="stepIndex.set($event.selectedIndex)">
