...
import { PageHeader, statusColor, statusLabel, initials } from "./shared"
const search = ref("")
...
<template>
  <div class="page">
    ...
    <a-card>
      ...
      <a-pagination class="pagination" :total="filtered.length" show-size-changer show-quick-jumper />
    </a-card>
...
<style scoped>.toolbar { display:flex; flex-wrap:wrap; gap:10px; margin-bottom:18px; }.pagination { margin-top:18px; text-align:right; }</style>
