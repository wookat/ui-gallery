  ...
  <q-layout view="lHh Lpr lFf" class="landing-page">
    <q-header bordered>
      <q-toolbar class="landing-container">
        ...
        <q-btn class="lt-md" flat round aria-label="打开菜单" @click="drawer = true"><AppIcon name="menu" /></q-btn>
      </q-toolbar>
    </q-header>
