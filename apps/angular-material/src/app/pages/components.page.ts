...
export class App &#123;&#125;</code></pre><button matButton (click)="copy(codeSample)"><mat-icon svgIcon="copy"></mat-icon>复制代码</button></app-demo-card>
      ...
      <section class="component-grid">
        ...
        <app-demo-card name="Steps" hint="横向 · 纵向 stepper" [wide]="true"><mat-stepper [selectedIndex]="1" animationDuration="0ms"><mat-step label="基本信息" [completed]="true"></mat-step><mat-step label="详细配置"></mat-step><mat-step label="确认"></mat-step></mat-stepper><mat-stepper orientation="vertical" [selectedIndex]="0" animationDuration="0ms"><mat-step label="创建活动"><p class="muted">纵向步骤内容</p></mat-step><mat-step label="邀请成员" optional></mat-step></mat-stepper></app-demo-card>
