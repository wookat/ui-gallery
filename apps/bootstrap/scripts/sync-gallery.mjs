...
const source = readFileSync(`${root}apps/bootstrap/src/coverage.ts`, "utf8")
const galleryPath = `${root}apps/bootstrap/gallery.json`
...
if (missing.length) throw new Error(`coverage.ts lacks: ${missing.join(", ")}`)
